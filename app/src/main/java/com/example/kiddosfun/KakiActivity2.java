...
public class KakiActivity2 extends AppCompatActivity {
    ...
    public void btn_stage (View view){
        Intent intent = new Intent(KakiActivity2.this,TampilanAnggotaTubuhActivity2.class);
        startActivity(intent);
    }
    public void btn_next (View view){Intent intent = new Intent(KakiActivity2.this,OtakActivity2.class);
        startActivity(intent);
    }
