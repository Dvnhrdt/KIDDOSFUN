...
public class AyamActivity2 extends AppCompatActivity {
    ...
    public void btn_stage (View view){
        Intent intent = new Intent(AyamActivity2.this,TampilanHewanActivity2.class);
        startActivity(intent);
    }
    public void btn_next (View view){
        Intent intent = new Intent(AyamActivity2.this,MonyetActivity2.class);
        startActivity(intent);
    }
    ...
    public void btn_sound(View view) {
        if (player == null) {
            player = MediaPlayer.create(this, R. raw.sound_ayam);
        }
        player.start();
    }
}